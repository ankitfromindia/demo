...
(function($){
	$.fn.slider = function( options ){
		...
		var settings = $.extend({
			...
			spacing		: null,
			slideList	: null,
                        arrowClass      : 'common-sprite',//Arrow class
			complete	: null
		}, options);
		...
		return this.each(function(){
			...
			if(lstNo > settings.slideList && lstNo < minLst){
			...
			if(lstNo > settings.slideList){
                        ...
                        $(this).parent('.sliderDiv').after('<a href="javascript:void(0)" class="' + settings.arrowClass + ' sl-prev">prev</a><a href="javascript:void(0)" class="' + settings.arrowClass + ' sl-next">next</a><div class="clear"></div>');
			}
